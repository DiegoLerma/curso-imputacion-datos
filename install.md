# imputacion-valores-faltantes guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `impultacion-module/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `impultacion-module` folder and use the modules inside your notebooks :
...
```python
from impultacion-module.utils.paths import data_dir
data_dir()
```
